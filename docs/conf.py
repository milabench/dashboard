#!/usr/bin/env python
"""
dashboard documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "dashboard"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import dashboard.core  # noqa
...
project = "dashboard"
_full_version = dashboard.core.__version__
author = dashboard.core.__author__
copyright = dashboard.core.__copyright__
